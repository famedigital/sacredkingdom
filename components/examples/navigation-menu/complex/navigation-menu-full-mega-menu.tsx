              ...
              <div className="w-[900px] p-6">
                <div className="grid grid-cols-[2fr_1fr_1fr] gap-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      <h4 className="mb-3 font-semibold text-muted-foreground text-sm">ADVANCED</h4>
                      <div className="space-y-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <h4 className="mb-3 font-semibold text-muted-foreground text-sm">COMPANY</h4>
                      <div className="space-y-2">
                        {company.map(item => (
                  ...
                  <div className="space-y-4">
                    <div className="rounded-lg bg-muted p-4">
                      ...
                      <div className="mt-3 space-y-2">
                        <h4 className="font-semibold">{sidebar.tutorial.title}</h4>
